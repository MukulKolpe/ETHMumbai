...
export class NFT extends ethereum.SmartContract {
  ...
  mintProperty(tokenURI: string): BigInt {
    let result = super.call("mintProperty", "mintProperty(string):(uint256)", [
  ...
  try_mintProperty(tokenURI: string): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "mintProperty",
      "mintProperty(string):(uint256)",
      [ethereum.Value.fromString(tokenURI)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
